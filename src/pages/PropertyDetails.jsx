      ...
      <div className=' flex flex-col items-start gap-8
       lg:flex-row'>
        <div className=' max-w-[768px]'>
          ...
          <div className=' mt-5'>{house.description}</div>
        </div>
        ...
        <form className=' flex flex-col gap-y-4'>
          <input className=' border border-gray-300 
           focus:border-violet-700 outline-none rounded
            w-full px-4 h-14 text-sm' type="text" 
            placeholder='Name'/>
          <input className=' border border-gray-300 
           focus:border-violet-700 outline-none rounded
            w-full px-4 h-14 text-sm' type="text" 
          ...
          <textarea
          placeholder='Message'
          defaultValue='Hello, I am interested in Modern
           apartment'
           className=' border border-gray-300
           focus:border-violet-700 outline-none resize-none
            rounded w-full p-4 h-36 text-sm text-gray-400'></textarea>
          <div className=' flex gap-x-3'>
            <button className=' bg-violet-700 hover:bg-violet-800
             text-white rounded p-4 text-sm w-full
              transition'>Send message</button>
            <button className='border border-violet-700 hover:border-violet-800
              rounded p-4 text-sm w-full
              transition'>Call</button>
          </div>
        </form>
        </div>
      </div>
