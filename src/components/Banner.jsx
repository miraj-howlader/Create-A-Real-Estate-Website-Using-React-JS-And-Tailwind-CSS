    ...
    <div className=' flex flex-col lg:flex-row'>
      <div className=' lg:ml-8 xl:ml-[135px] flex flex-col
       items-center lg:items-start text-center lg:text-left
        ...
        <p className=' max-w-[480px] mb-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci ullam sapiente repellat dolores nam facilis architecto maiores earum ut perspiciatis?</p>
      </div>
      {/* image  */}
